  ...
  return (
    <div>
      ...
      {isMobileView ?
        (
          <div>
            <div className='bg-slate-200 rounded-xl p-2 shadow-lg '>
              ...
              <div className='max-h-[70vh] min-h-[50vh] overflow-y-scroll'>
                {groupTab !== null ? productGroups[groupTab]?.items?.map((item) => (
                  <div className=' bg-slate-200 hover:bg-slate-300 cursor-pointer border-b-[1px] border-slate-400 w-full '>
        ...
        <div className='max-w-full overflow-x-scroll'>
          <div className='flex h-[550px] min-w-max rounded-xl overflow-hidden bg-slate-200 drop-shadow py-2'>
            <div className='min-w-[210px] max-w-max overflow-y-scroll'>
              ...
              {!loading &&
                <div
                  className={`cursor-pointer hover:bg-slate-300 border-b-[1px] border-slate-400  p-2 w-full bg-slate-200 ${!selectedGroup ? 'bg-slate-300' : ''}`}
              ...
              {!loading ? productGroups.map((group) => (
                <div
                  key={group.id}
                  className={`cursor-pointer hover:bg-slate-300 border-b-[1px] border-slate-400  p-2 w-full bg-slate-200 ${selectedGroup?.id === group.id ? 'bg-slate-300' : ''
                    }`}
            ...
            <main className='w-[370px] bg-slate-200 border-x-[1px] border-slate-300 overflow-y-scroll'>
              {selectedGroup ? (
                <div>
                  ...
                  {selectedGroup.items.map((item) => (
                    <div
                      key={item.id}
                      className='cursor-pointer p-2 flex items-center justify-between  border-b-[1px] border-slate-400 w-full bg-slate-200 hover:bg-slate-300'>
            ...
            <div className='bg-slate-200 px-2 max-w-[500px]' >
                    ...
                    <tbody>
                      {addedItems.map((item, i) => (
                        <tr key={i}
                          ...
                          className={`hover:bg-white cursor-pointer ${i % 2 === 0 ? 'bg-slate-300' : 'bg-slate-200'}`}>
