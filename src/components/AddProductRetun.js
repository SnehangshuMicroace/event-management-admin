      ...
      {isMobileView ?
            ...
            <div className='bg-slate-200 rounded-xl p-2 shadow-lg '>
              ...
              <div className='mb-12 max-h-[70vh] min-h-[50vh] overflow-y-scroll'>
                {productGroups[groupTab]?.items?.map((item) => (
                  <div key={item.id} className='cursor-pointer px-2 py-1  border-b-[1px] border-slate-400 w-full flex items-center justify-between bg-slate-200 hover:bg-slate-300'>
        ...
        <div className='max-w-full overflow-x-scroll'>
          <div className='flex h-[550px] min-w-max rounded-xl overflow-hidden bg-slate-200 drop-shadow py-2'>
              ...
              {selectedGroup ? (
                <div>
                  ...
                  {selectedGroup.items.map((item) => (
                    <div
                      key={item.id}
                      className='cursor-pointer px-2 flex items-center justify-between  border-b-[1px] border-slate-400 w-full bg-slate-200 hover:bg-slate-300'>
            ...
            <div className='bg-slate-200 px-2 min-w-[450px]' >
