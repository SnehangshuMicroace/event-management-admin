  ...
  return (
    <div className="container mx-auto m-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg printable-content" id="printableContent">
        <div className='flex justify-start p-2 bg-slate-200 -mx-6 px-4'>
        ...
        <div className=''>
          ...
          <h2 className="text-xl font-semibold mb-2 bg-slate-200 -mx-6 px-4 py-1">Customer Details</h2>
          <p className='text-slate-500 font-semibold text-2xl'>{customerInfo.NAME}</p>
          <p><strong>contact No :</strong> {customerInfo.MOBPHONE}</p>
        </div>
          <div className="mt-4">
            <h2 className="text-xl font-semibold mb-2 bg-slate-200 -mx-6 px-4 py-1">Special Order</h2>
