  ...
  return (
    <div className="container mx-auto m-8">
      <div className="bg-white p-6 rounded-lg shadow-lg printable-content" id="printableContent">
        <div className='flex justify-start p-2 bg-slate-200 text-slate-500 -mx-6 px-4'>
        ...
        {customerInfo && (
          <div className=''>
            ...
            <h2 className="text-xl font-semibold mb-2 bg-slate-200 -mx-6 px-4">Vendor Details</h2>
